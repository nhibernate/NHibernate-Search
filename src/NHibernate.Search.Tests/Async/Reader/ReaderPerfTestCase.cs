...
namespace NHibernate.Search.Tests.Reader
{
    ...
    [TestFixture]
    public class ReaderPerfTestCaseAsync : PhysicalTestCase
    {
        ...
        public async Task ConcurrencyAsync()
        {
            ...
            do
            {
                ...
                await (Task.Delay(20)); // Wait that all the threads have been terminated before, otherwise, they will be aborted
            }
